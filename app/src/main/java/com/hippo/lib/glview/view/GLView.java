...
import com.hippo.lib.glview.view.TouchHelper;
import com.hippo.lib.glview.view.TouchOwner;
...
public class GLView implements TouchOwner {
    ...
    private com.hippo.lib.glview.view.GLRoot mRoot;
    ...
    public void startAnimation(CanvasAnimation animation, boolean atOnce) {
        com.hippo.lib.glview.view.GLRoot root = getGLRoot();
    ...
    void attachToRoot(com.hippo.lib.glview.view.GLRoot root) {
    ...
    public com.hippo.lib.glview.view.GLRoot getGLRoot() {
        return mRoot;
    }
    ...
    public void getValidRect(Rect rect) {
        com.hippo.lib.glview.view.GLRoot root = mRoot;
        if (root == null) {
            rect.setEmpty();
            return;
        }
