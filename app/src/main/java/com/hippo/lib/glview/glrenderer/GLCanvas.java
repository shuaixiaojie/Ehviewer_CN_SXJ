...
import com.hippo.lib.glview.glrenderer.GLId;
import com.hippo.lib.glview.glrenderer.GLPaint;
import com.hippo.lib.glview.glrenderer.RawTexture;
...
public interface GLCanvas {
    ...
    void drawLine(float x1, float y1, float x2, float y2, com.hippo.lib.glview.glrenderer.GLPaint paint);

    // Draws a rectangle using the specified paint from (x1, y1) to (x2, y2).
    // (Both end points are included).
    void drawRect(float x1, float y1, float x2, float y2, com.hippo.lib.glview.glrenderer.GLPaint paint);
    ...
    void drawOval(float cx, float cy, float radiusX, float radiusY,
            com.hippo.lib.glview.glrenderer.GLPaint paint);
