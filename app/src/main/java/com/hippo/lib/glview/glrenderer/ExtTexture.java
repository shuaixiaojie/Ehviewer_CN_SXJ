...
public class ExtTexture extends BasicTexture {
    ...
    public ExtTexture(com.hippo.lib.glview.glrenderer.GLCanvas canvas, int target) {
        GLId glId = canvas.getGLId();
        mId = glId.generateTexture();
        mTarget = target;
    }

    private void uploadToCanvas(com.hippo.lib.glview.glrenderer.GLCanvas canvas) {
