...
//        }
    ...
    @Override
    public void setContentPane(com.hippo.lib.glview.view.GLView content) {
    ...
    private void layoutContentPane() {
        ...
        if (mContentView != null && w != 0 && h != 0) {
            mContentView.measure(com.hippo.lib.glview.view.GLView.MeasureSpec.makeMeasureSpec(w, com.hippo.lib.glview.view.GLView.MeasureSpec.EXACTLY),
                    com.hippo.lib.glview.view.GLView.MeasureSpec.makeMeasureSpec(h, GLView.MeasureSpec.EXACTLY));
