...
public abstract class BasicTexture implements Texture {
    ...
    protected com.hippo.lib.glview.glrenderer.GLCanvas mCanvasRef = null;
    ...
    protected BasicTexture(com.hippo.lib.glview.glrenderer.GLCanvas canvas, int id, int state) {
    ...
    protected void setAssociatedCanvas(com.hippo.lib.glview.glrenderer.GLCanvas canvas) {
        mCanvasRef = canvas;
    }
    ...
    @Override
    public void draw(com.hippo.lib.glview.glrenderer.GLCanvas canvas, int x, int y) {
        canvas.drawTexture(this, x, y, getWidth(), getHeight());
    }

    @Override
    public void draw(com.hippo.lib.glview.glrenderer.GLCanvas canvas, int x, int y, int w, int h) {
        canvas.drawTexture(this, x, y, w, h);
    }

    @Override
    public void draw(com.hippo.lib.glview.glrenderer.GLCanvas canvas, RectF source, RectF target) {
        canvas.drawTexture(this, source, target);
    }

    // onBind is called before GLCanvas binds this texture.
    // It should make sure the data is uploaded to GL memory.
    abstract protected boolean onBind(com.hippo.lib.glview.glrenderer.GLCanvas canvas);
